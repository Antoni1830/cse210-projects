        ...
        switch (menuSelected) {
            case "1":
                ...
                switch (goalType) {
                    ...
                    case "2":
                        EternalG newEternalG = new EternalG();
                        newEternalG.CreateChildGoal();
                        goals.addGoal(newEternalG);
                        break;

                    case "3":
                        ChecklistG newChecklistG = new ChecklistG();
                        newChecklistG.CreateChildG();
                        goals.addGoal(newChecklistG);
                        break;
